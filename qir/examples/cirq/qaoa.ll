...
entry:
  ...
  %m = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 6)
  %m_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 0)
  %m_result_0 = bitcast i8* %m_0_raw to %Result**
  ...
  store %Result* %zero_0, %Result** %m_result_0, align 8
  %m_1_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 1)
  %m_result_1 = bitcast i8* %m_1_raw to %Result**
  ...
  store %Result* %zero_1, %Result** %m_result_1, align 8
  %m_2_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 2)
  %m_result_2 = bitcast i8* %m_2_raw to %Result**
  ...
  store %Result* %zero_2, %Result** %m_result_2, align 8
  %m_3_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 3)
  %m_result_3 = bitcast i8* %m_3_raw to %Result**
  ...
  store %Result* %zero_3, %Result** %m_result_3, align 8
  %m_4_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 4)
  %m_result_4 = bitcast i8* %m_4_raw to %Result**
  ...
  store %Result* %zero_4, %Result** %m_result_4, align 8
  %m_5_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 5)
  %m_result_5 = bitcast i8* %m_5_raw to %Result**
  ...
  store %Result* %zero_5, %Result** %m_result_5, align 8
  ...
  store %Array* %m, %Array** %results_result_tmp_result_0, align 8
  ...
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x3FFDA7C18D686C8A, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x3FFDA7C18D686C8A, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x3FFDA7C18D686C8A, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x400482B0228FE6AF, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x3FFDA7C18D686C8A, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x3FFDA7C18D686C8A, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x3FFDA7C18D686C8A, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x4008152C774A9AA4, %Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x4008152C774A9AA4, %Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x4008152C774A9AA4, %Qubit* %q2)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q5)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double 0x3FFBE059876B8FC6, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x4008152C774A9AA4, %Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x4008152C774A9AA4, %Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__Rx__body(double 0x4008152C774A9AA4, %Qubit* %q5)
  %measurement = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q4)
  %m0_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 0)
  %m0_result_0 = bitcast i8* %m0_0_raw to %Result**
  %existing_value = load %Result*, %Result** %m0_result_0, align 8
  ...
  store %Result* %measurement, %Result** %m0_result_0, align 8
  %measurement1 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q1)
  %m1_1_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 1)
  %m1_result_1 = bitcast i8* %m1_1_raw to %Result**
  %existing_value2 = load %Result*, %Result** %m1_result_1, align 8
  ...
  store %Result* %measurement1, %Result** %m1_result_1, align 8
  %measurement3 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q0)
  %m2_2_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 2)
  %m2_result_2 = bitcast i8* %m2_2_raw to %Result**
  %existing_value4 = load %Result*, %Result** %m2_result_2, align 8
  ...
  store %Result* %measurement3, %Result** %m2_result_2, align 8
  %measurement5 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q3)
  %m3_3_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 3)
  %m3_result_3 = bitcast i8* %m3_3_raw to %Result**
  %existing_value6 = load %Result*, %Result** %m3_result_3, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value6, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement5, i32 1)
  store %Result* %measurement5, %Result** %m3_result_3, align 8
  %measurement7 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q2)
  %m4_4_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 4)
  %m4_result_4 = bitcast i8* %m4_4_raw to %Result**
  %existing_value8 = load %Result*, %Result** %m4_result_4, align 8
  ...
  store %Result* %measurement7, %Result** %m4_result_4, align 8
  %measurement9 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q5)
  %m5_5_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %m, i64 5)
  %m5_result_5 = bitcast i8* %m5_5_raw to %Result**
  %existing_value10 = load %Result*, %Result** %m5_result_5, align 8
  ...
  store %Result* %measurement9, %Result** %m5_result_5, align 8
