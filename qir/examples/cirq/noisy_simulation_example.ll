...
entry:
  ...
  %initial_state = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %initial_state_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %initial_state, i64 0)
  %initial_state_result_0 = bitcast i8* %initial_state_0_raw to %Result**
  ...
  store %Result* %zero_0, %Result** %initial_state_result_0, align 8
  %after_not_gate = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %after_not_gate_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %after_not_gate, i64 0)
  %after_not_gate_result_0 = bitcast i8* %after_not_gate_0_raw to %Result**
  ...
  store %Result* %zero_01, %Result** %after_not_gate_result_0, align 8
  ...
  store %Array* %initial_state, %Array** %results_result_tmp_result_0, align 8
  ...
  store %Array* %after_not_gate, %Array** %results_result_tmp_result_1, align 8
  %measurement = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q0)
  %initial_state0_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %initial_state, i64 0)
  %initial_state0_result_0 = bitcast i8* %initial_state0_0_raw to %Result**
  %existing_value = load %Result*, %Result** %initial_state0_result_0, align 8
  ...
  store %Result* %measurement, %Result** %initial_state0_result_0, align 8
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %q0)
  %measurement2 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q0)
  %after_not_gate0_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %after_not_gate, i64 0)
  %after_not_gate0_result_0 = bitcast i8* %after_not_gate0_0_raw to %Result**
  %existing_value3 = load %Result*, %Result** %after_not_gate0_result_0, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value3, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement2, i32 1)
  store %Result* %measurement2, %Result** %after_not_gate0_result_0, align 8
