...
entry:
  ...
  %result = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  ...
  store %Qubit* %q1, %Qubit** %__controlQubits__0_result_tmp_result_0, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__, %Qubit* %q0)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__, i32 -1)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %q1)
  %measurement = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q1)
