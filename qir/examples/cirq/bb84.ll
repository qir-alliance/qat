...
entry:
  ...
  %results = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 8)
  %"0" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"0_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"0", i64 0)
  %"0_result_0" = bitcast i8* %"0_0_raw" to %Result**
  ...
  store %Result* %zero_0, %Result** %"0_result_0", align 8
  %"1" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"1_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"1", i64 0)
  %"1_result_0" = bitcast i8* %"1_0_raw" to %Result**
  ...
  store %Result* %zero_01, %Result** %"1_result_0", align 8
  %"4" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"4_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"4", i64 0)
  %"4_result_0" = bitcast i8* %"4_0_raw" to %Result**
  %zero_02 = call %Result* @__quantum__rt__result_get_zero()
  call void @__quantum__rt__result_update_reference_count(%Result* %zero_02, i32 1)
  store %Result* %zero_02, %Result** %"4_result_0", align 8
  %"6" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"6_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"6", i64 0)
  %"6_result_0" = bitcast i8* %"6_0_raw" to %Result**
  %zero_03 = call %Result* @__quantum__rt__result_get_zero()
  call void @__quantum__rt__result_update_reference_count(%Result* %zero_03, i32 1)
  store %Result* %zero_03, %Result** %"6_result_0", align 8
  %"2" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"2_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"2", i64 0)
  %"2_result_0" = bitcast i8* %"2_0_raw" to %Result**
  ...
  store %Result* %zero_04, %Result** %"2_result_0", align 8
  %"3" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"3_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"3", i64 0)
  %"3_result_0" = bitcast i8* %"3_0_raw" to %Result**
  %zero_05 = call %Result* @__quantum__rt__result_get_zero()
  call void @__quantum__rt__result_update_reference_count(%Result* %zero_05, i32 1)
  store %Result* %zero_05, %Result** %"3_result_0", align 8
  %"5" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"5_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"5", i64 0)
  %"5_result_0" = bitcast i8* %"5_0_raw" to %Result**
  %zero_06 = call %Result* @__quantum__rt__result_get_zero()
  call void @__quantum__rt__result_update_reference_count(%Result* %zero_06, i32 1)
  store %Result* %zero_06, %Result** %"5_result_0", align 8
  %"7" = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %"7_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"7", i64 0)
  %"7_result_0" = bitcast i8* %"7_0_raw" to %Result**
  %zero_07 = call %Result* @__quantum__rt__result_get_zero()
  call void @__quantum__rt__result_update_reference_count(%Result* %zero_07, i32 1)
  store %Result* %zero_07, %Result** %"7_result_0", align 8
  ...
  store %Array* %"0", %Array** %results_result_tmp_result_0, align 8
  ...
  store %Array* %"1", %Array** %results_result_tmp_result_1, align 8
  ...
  store %Array* %"4", %Array** %results_result_tmp_result_2, align 8
  %results_result_tmp_3_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %results, i64 3)
  %results_result_tmp_result_3 = bitcast i8* %results_result_tmp_3_raw to %Array**
  store %Array* %"6", %Array** %results_result_tmp_result_3, align 8
  %results_result_tmp_4_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %results, i64 4)
  %results_result_tmp_result_4 = bitcast i8* %results_result_tmp_4_raw to %Array**
  store %Array* %"2", %Array** %results_result_tmp_result_4, align 8
  %results_result_tmp_5_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %results, i64 5)
  %results_result_tmp_result_5 = bitcast i8* %results_result_tmp_5_raw to %Array**
  store %Array* %"3", %Array** %results_result_tmp_result_5, align 8
  %results_result_tmp_6_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %results, i64 6)
  %results_result_tmp_result_6 = bitcast i8* %results_result_tmp_6_raw to %Array**
  store %Array* %"5", %Array** %results_result_tmp_result_6, align 8
  %results_result_tmp_7_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %results, i64 7)
  %results_result_tmp_result_7 = bitcast i8* %results_result_tmp_7_raw to %Array**
  store %Array* %"7", %Array** %results_result_tmp_result_7, align 8
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %q0)
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %q4)
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %q7)
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %q6)
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %q3)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %q1)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %q2)
  %measurement = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q5)
  %"00_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"0", i64 0)
  %"00_result_0" = bitcast i8* %"00_0_raw" to %Result**
  %existing_value = load %Result*, %Result** %"00_result_0", align 8
  ...
  store %Result* %measurement, %Result** %"00_result_0", align 8
  ...
  %measurement8 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q1)
  %"10_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"1", i64 0)
  %"10_result_0" = bitcast i8* %"10_0_raw" to %Result**
  %existing_value9 = load %Result*, %Result** %"10_result_0", align 8
  ...
  store %Result* %measurement8, %Result** %"10_result_0", align 8
  %measurement10 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q2)
  %"40_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"4", i64 0)
  %"40_result_0" = bitcast i8* %"40_0_raw" to %Result**
  %existing_value11 = load %Result*, %Result** %"40_result_0", align 8
  ...
  store %Result* %measurement10, %Result** %"40_result_0", align 8
  %measurement12 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q6)
  %"60_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"6", i64 0)
  %"60_result_0" = bitcast i8* %"60_0_raw" to %Result**
  %existing_value13 = load %Result*, %Result** %"60_result_0", align 8
  ...
  store %Result* %measurement12, %Result** %"60_result_0", align 8
  %measurement14 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q0)
  %"20_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"2", i64 0)
  %"20_result_0" = bitcast i8* %"20_0_raw" to %Result**
  %existing_value15 = load %Result*, %Result** %"20_result_0", align 8
  ...
  store %Result* %measurement14, %Result** %"20_result_0", align 8
  %measurement16 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q4)
  %"30_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"3", i64 0)
  %"30_result_0" = bitcast i8* %"30_0_raw" to %Result**
  %existing_value17 = load %Result*, %Result** %"30_result_0", align 8
  ...
  store %Result* %measurement16, %Result** %"30_result_0", align 8
  %measurement18 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q7)
  %"50_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"5", i64 0)
  %"50_result_0" = bitcast i8* %"50_0_raw" to %Result**
  %existing_value19 = load %Result*, %Result** %"50_result_0", align 8
  ...
  store %Result* %measurement18, %Result** %"50_result_0", align 8
  %measurement20 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q3)
  %"70_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"7", i64 0)
  %"70_result_0" = bitcast i8* %"70_0_raw" to %Result**
  %existing_value21 = load %Result*, %Result** %"70_result_0", align 8
  ...
  store %Result* %measurement20, %Result** %"70_result_0", align 8
