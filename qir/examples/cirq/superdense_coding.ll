...
entry:
  ...
  %results = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 2)
  %"input " = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 2)
  %"input _0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"input ", i64 0)
  %"input _result_0" = bitcast i8* %"input _0_raw" to %Result**
  ...
  store %Result* %zero_0, %Result** %"input _result_0", align 8
  %"input _1_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"input ", i64 1)
  %"input _result_1" = bitcast i8* %"input _1_raw" to %Result**
  ...
  store %Result* %zero_1, %Result** %"input _result_1", align 8
  ...
  store %Result* %zero_01, %Result** %output_result_0, align 8
  ...
  store %Result* %zero_12, %Result** %output_result_1, align 8
  ...
  store %Array* %"input ", %Array** %results_result_tmp_result_0, align 8
  ...
  store %Array* %output, %Array** %results_result_tmp_result_1, align 8
  ...
  %"input 0_0_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"input ", i64 0)
  %"input 0_result_0" = bitcast i8* %"input 0_0_raw" to %Result**
  %existing_value = load %Result*, %Result** %"input 0_result_0", align 8
  ...
  store %Result* %measurement, %Result** %"input 0_result_0", align 8
  %measurement3 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q1)
  %"input 1_1_raw" = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %"input ", i64 1)
  %"input 1_result_1" = bitcast i8* %"input 1_1_raw" to %Result**
  %existing_value4 = load %Result*, %Result** %"input 1_result_1", align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value4, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement3, i32 1)
  store %Result* %measurement3, %Result** %"input 1_result_1", align 8
  ...
  %__controlQubits__5 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %__controlQubits__0_result_tmp_0_raw6 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__5, i64 0)
  %__controlQubits__0_result_tmp_result_07 = bitcast i8* %__controlQubits__0_result_tmp_0_raw6 to %Qubit**
  store %Qubit* %q1, %Qubit** %__controlQubits__0_result_tmp_result_07, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__5, %Qubit* %q0)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__5, i32 -1)
  %__controlQubits__8 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %__controlQubits__0_result_tmp_0_raw9 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__8, i64 0)
  %__controlQubits__0_result_tmp_result_010 = bitcast i8* %__controlQubits__0_result_tmp_0_raw9 to %Qubit**
  store %Qubit* %q4, %Qubit** %__controlQubits__0_result_tmp_result_010, align 8
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__8, %Qubit* %q0)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__8, i32 -1)
  %__controlQubits__11 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %__controlQubits__0_result_tmp_0_raw12 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__11, i64 0)
  %__controlQubits__0_result_tmp_result_013 = bitcast i8* %__controlQubits__0_result_tmp_0_raw12 to %Qubit**
  store %Qubit* %q0, %Qubit** %__controlQubits__0_result_tmp_result_013, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__11, %Qubit* %q3)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__11, i32 -1)
  %__controlQubits__14 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %__controlQubits__0_result_tmp_0_raw15 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__14, i64 0)
  %__controlQubits__0_result_tmp_result_016 = bitcast i8* %__controlQubits__0_result_tmp_0_raw15 to %Qubit**
  store %Qubit* %q3, %Qubit** %__controlQubits__0_result_tmp_result_016, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__14, %Qubit* %q0)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__14, i32 -1)
  %__controlQubits__17 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %__controlQubits__0_result_tmp_0_raw18 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__17, i64 0)
  %__controlQubits__0_result_tmp_result_019 = bitcast i8* %__controlQubits__0_result_tmp_0_raw18 to %Qubit**
  store %Qubit* %q0, %Qubit** %__controlQubits__0_result_tmp_result_019, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__17, %Qubit* %q3)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__17, i32 -1)
  %__controlQubits__20 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %__controlQubits__0_result_tmp_0_raw21 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %__controlQubits__20, i64 0)
  %__controlQubits__0_result_tmp_result_022 = bitcast i8* %__controlQubits__0_result_tmp_0_raw21 to %Qubit**
  store %Qubit* %q3, %Qubit** %__controlQubits__0_result_tmp_result_022, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__20, %Qubit* %q2)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__20, i32 -1)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %q3)
  %measurement23 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q3)
  ...
  %existing_value24 = load %Result*, %Result** %output0_result_0, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value24, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement23, i32 1)
  store %Result* %measurement23, %Result** %output0_result_0, align 8
  %measurement25 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q2)
  ...
  %existing_value26 = load %Result*, %Result** %output1_result_1, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value26, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement25, i32 1)
  store %Result* %measurement25, %Result** %output1_result_1, align 8
