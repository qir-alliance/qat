...
entry:
  ...
  %result = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 6)
  ...
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %q1)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__, %Qubit* %q4)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__1, %Qubit* %q5)
  ...
  store %Qubit* %q1, %Qubit** %__controlQubits__0_result_tmp_result_06, align 8
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__4, %Qubit* %q2)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__7, %Qubit* %q4)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__10, %Qubit* %q5)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__ctl(%Array* %__controlQubits__13, %Qubit* %q2)
  ...
  %existing_value17 = load %Result*, %Result** %result1_result_1, align 8
  ...
  store %Result* %measurement16, %Result** %result1_result_1, align 8
  %measurement18 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q0)
  ...
  %existing_value19 = load %Result*, %Result** %result2_result_2, align 8
  ...
  store %Result* %measurement18, %Result** %result2_result_2, align 8
  %measurement20 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q5)
  ...
  %existing_value21 = load %Result*, %Result** %result3_result_3, align 8
  ...
  store %Result* %measurement20, %Result** %result3_result_3, align 8
  %measurement22 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q1)
  ...
  %existing_value23 = load %Result*, %Result** %result4_result_4, align 8
  ...
  store %Result* %measurement22, %Result** %result4_result_4, align 8
  %measurement24 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q2)
  ...
  %existing_value25 = load %Result*, %Result** %result5_result_5, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value25, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement24, i32 1)
  store %Result* %measurement24, %Result** %result5_result_5, align 8
