  ...
  public:
    ...
    bool isDisabled() const
    {
        return (
            ...
            optimize_result_one_ == false && optimize_result_zero_ == false && optimize_qauntum_constants_ == false &&
            remove_get_one_or_zero_ == false && use_static_qubit_array_allocation_ == false &&
