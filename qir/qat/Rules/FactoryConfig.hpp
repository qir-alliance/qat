      ...
      public:
        void setup(ConfigurationManager& config)
        {
            ...
            config.addExperimentalParameter(
                disable_reference_counting_, false, true, "disable-reference-counting",
            ...
            config.addExperimentalParameter(
                ...
                "Disables reference counting by instruction removal.");
            config.addExperimentalParameter(
                disable_alias_counting_, false, true, "disable-alias-counting",
                "Disables alias counting by instruction removal.");
            config.addExperimentalParameter(
                disable_string_support_, false, true, "disable-string-support",
