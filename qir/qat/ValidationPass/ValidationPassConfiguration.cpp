...
ValidationPassConfiguration ValidationPassConfiguration::fromProfileName(String const &name)
{
  ...
  else if (name == "base")
  {
    ...
    profile.external_calls_ = Set{
        ...
        "__quantum__qis__h__body",    "__quantum__qis__s__body",
        "__quantum__qis__s__adj",     "__quantum__qis__t__body",
        "__quantum__qis__t__adj",     "__quantum__qis__x__body",
...
ValidationPassConfiguration::Set const &ValidationPassConfiguration::allowedExternalCallNames()
    const
{
