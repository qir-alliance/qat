...
public:
  void setup(ConfigurationManager &config)
  {
    ...
    config.addParameter(should_eleminate_zext_i1_, "should-eleminate-zext-i1",
                        "Replace zext instruction for i1 with select.");
    config.addParameter(should_pull_records_back_, "pull-records-back");
  }
  ...
  bool shouldPullRecodsBack() const
  {
    return ret.should_pull_records_back_;
  }
