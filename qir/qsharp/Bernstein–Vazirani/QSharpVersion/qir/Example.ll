...
@0 = internal constant [62 x i8] c"Length of input register must be equal to the pattern length.\00"
...
@5 = internal constant [18 x i8] c"Unsupported input\00"
...
@6 = internal constant [3 x i8] c", \00"
@7 = internal constant [2 x i8] c"[\00"
@8 = internal constant [2 x i8] c"]\00"

define internal %Array* @Tets__Samples__BernVaz__BernsteinVaziraniTestCase__body(i64 %nQubits, i64 %patternInt) {
entry:
  ...
  %0 = call %Callable* @Tets__Samples__BernVaz__ParityOperation__body(%Array* %pattern)
  %1 = call %Array* @Tets__Samples__BernVaz__ParityViaFourierSampling__body(%Callable* %0, i64 %nQubits)
  call void @__quantum__rt__array_update_alias_count(%Array* %pattern, i32 -1)
...
condContinue__2:                                  ; preds = %condTrue__2, %condContinue__1
  ...
  %15 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @2, i32 0, i32 0))
  ...
  %18 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @3, i32 0, i32 0))
  ...
  %22 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @4, i32 0, i32 0))
...
define internal %Array* @Tets__Samples__BernVaz__ParityViaFourierSampling__body(%Callable* %Uf, i64 %n) {
entry:
  ...
  call void @Microsoft__Quantum__Canon___39dfe51c583543f498e8bf10371eafe0_ApplyToEachA__body(%Callable* %0, %Array* %queryRegister)
  ...
  call void @Microsoft__Quantum__Canon___39dfe51c583543f498e8bf10371eafe0_ApplyToEachA__adj(%Callable* %5, %Array* %queryRegister)
  ...
  %7 = call %Array* @Microsoft__Quantum__Arrays___ef15a9ab7192403986212d60c0794f7d_ForEach__body(%Callable* %6, %Array* %queryRegister)
  call void @__quantum__rt__array_update_alias_count(%Array* %queryRegister, i32 -1)
  call void @__quantum__rt__capture_update_alias_count(%Callable* %Uf, i32 -1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %Uf, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
...
define internal %Callable* @Tets__Samples__BernVaz__ParityOperation__body(%Array* %pattern) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %pattern, i32 1)
  ...
  %4 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Tets__Samples__BernVaz__ParityOperationImpl__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  call void @__quantum__rt__array_update_reference_count(%Array* %pattern, i32 1)
...
define internal void @Tets__Samples__BernVaz__ParityOperationImpl__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  ...
  call void @Tets__Samples__BernVaz__ParityOperationImpl__body(%Array* %4, %Array* %5, %Qubit* %6)
  ret void
}
...
define internal void @Tets__Samples__BernVaz__ParityOperationImpl__body(%Array* %pattern, %Array* %queryRegister, %Qubit* %target) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %pattern, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %queryRegister, i32 1)
...
then0__1:                                         ; preds = %entry
  %3 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([62 x i8], [62 x i8]* @0, i32 0, i32 0))
  call void @__quantum__rt__array_update_alias_count(%Array* %pattern, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %queryRegister, i32 -1)
...
continue__1:                                      ; preds = %entry
  %4 = call %Array* @Microsoft__Quantum__Arrays___0e8455ada4c0469d89c10593a7b822a3_Zip__body(%Array* %pattern, %Array* %queryRegister)
  %5 = call i64 @__quantum__rt__array_get_size_1d(%Array* %4)
  %6 = sub i64 %5, 1
  br label %header__1

header__1:                                        ; preds = %exiting__1, %continue__1
  %7 = phi i64 [ 0, %continue__1 ], [ %17, %exiting__1 ]
  %8 = icmp sle i64 %7, %6
...
then0__2:                                         ; preds = %body__1
  %14 = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %15 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %14, i64 0)
  %16 = bitcast i8* %15 to %Qubit**
  store %Qubit* %controlQubit, %Qubit** %16, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %14, %Qubit* %target)
...
body__2:                                          ; preds = %header__2
  %21 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %4, i64 %19)
...
define internal %Array* @Microsoft__Quantum__Arrays___0e8455ada4c0469d89c10593a7b822a3_Zip__body(%Array* %left, %Array* %right) {
entry:
  ...
  %0 = call %Array* @Microsoft__Quantum__Arrays___0d1b01e7e8734ec5a0abbe9f1c6388ed_Zipped__body(%Array* %left, %Array* %right)
  call void @__quantum__rt__array_update_alias_count(%Array* %left, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %right, i32 -1)
  ret %Array* %0
}
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___ccd3aa919e414498bd3c57225c7a0f99___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
define internal void @Microsoft__Quantum__Canon___39dfe51c583543f498e8bf10371eafe0_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___209fbb839fc341bcb6d88a7ef35ea810_IndexRange__body(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___39dfe51c583543f498e8bf10371eafe0_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___ef15a9ab7192403986212d60c0794f7d_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %9 = call %Range @Microsoft__Quantum__Arrays___209fbb839fc341bcb6d88a7ef35ea810_IndexRange__body(%Array* %array)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___ccd3aa919e414498bd3c57225c7a0f99___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal %Range @Microsoft__Quantum__Arrays___209fbb839fc341bcb6d88a7ef35ea810_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___0d1b01e7e8734ec5a0abbe9f1c6388ed_Zipped__body(%Array* %left, %Array* %right) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %left, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %right, i32 1)
...
else__1:                                          ; preds = %condContinue__7
  %33 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @5, i32 0, i32 0))
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___ccd3aa919e414498bd3c57225c7a0f99___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___42fc727c5688474eb9f208f7bb1ae1e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___42fc727c5688474eb9f208f7bb1ae1e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic___ccd3aa919e414498bd3c57225c7a0f99___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___91830b0ce12047b89002bcd3dc062a2f___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___91830b0ce12047b89002bcd3dc062a2f___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___91830b0ce12047b89002bcd3dc062a2f___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___ccd3aa919e414498bd3c57225c7a0f99___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___ccd3aa919e414498bd3c57225c7a0f99___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___91830b0ce12047b89002bcd3dc062a2f___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___42fc727c5688474eb9f208f7bb1ae1e8___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define { i64, i8* }* @Tets__Samples__BernVaz__BernsteinVaziraniTestCase__Interop(i64 %nQubits, i64 %patternInt) #1 {
entry:
  %0 = call %Array* @Tets__Samples__BernVaz__BernsteinVaziraniTestCase__body(i64 %nQubits, i64 %patternInt)
...
define void @Tets__Samples__BernVaz__BernsteinVaziraniTestCase(i64 %nQubits, i64 %patternInt) #2 {
entry:
  %0 = call %Array* @Tets__Samples__BernVaz__BernsteinVaziraniTestCase__body(i64 %nQubits, i64 %patternInt)
  %1 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @6, i32 0, i32 0))
  %2 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @7, i32 0, i32 0))
...
exit__1:                                          ; preds = %header__1
  %17 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @8, i32 0, i32 0))
