...
entry:
  ...
  call void @Microsoft__Quantum__Canon___95f05b9df7ab409981bcaee38787a22c_ApplyToEachA__body(%Callable* %0, %Array* %queryRegister)
  ...
  call void @Microsoft__Quantum__Canon___95f05b9df7ab409981bcaee38787a22c_ApplyToEachA__adj(%Callable* %5, %Array* %queryRegister)
  ...
  %7 = call %Array* @Microsoft__Quantum__Arrays___69f956a75aa646a7b8ab8cbae06ca577_ForEach__body(%Callable* %6, %Array* %queryRegister)
  call void @__quantum__rt__array_update_alias_count(%Array* %queryRegister, i32 -1)
  call void @__quantum__rt__capture_update_alias_count(%Callable* %Uf, i32 -1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %Uf, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
...
continue__1:                                      ; preds = %entry
  %4 = call %Array* @Microsoft__Quantum__Arrays___5152295299a747e8b17ea27e2189c69a_Zip__body(%Array* %pattern, %Array* %queryRegister)
...
define internal %Array* @Microsoft__Quantum__Arrays___5152295299a747e8b17ea27e2189c69a_Zip__body(%Array* %left, %Array* %right) {
entry:
  ...
  %0 = call %Array* @Microsoft__Quantum__Arrays___839ad0ddc3bd4f258006bfe6ed674492_Zipped__body(%Array* %left, %Array* %right)
  call void @__quantum__rt__array_update_alias_count(%Array* %left, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %right, i32 -1)
  ret %Array* %0
}
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3bd7ef4115f143c18e1e3a9956152519___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
define internal void @Microsoft__Quantum__Canon___95f05b9df7ab409981bcaee38787a22c_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___5e656316c77947c7b558fb587c7f71a8_IndexRange__body(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___95f05b9df7ab409981bcaee38787a22c_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___69f956a75aa646a7b8ab8cbae06ca577_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %9 = call %Range @Microsoft__Quantum__Arrays___5e656316c77947c7b558fb587c7f71a8_IndexRange__body(%Array* %array)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3bd7ef4115f143c18e1e3a9956152519___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal %Range @Microsoft__Quantum__Arrays___5e656316c77947c7b558fb587c7f71a8_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___839ad0ddc3bd4f258006bfe6ed674492_Zipped__body(%Array* %left, %Array* %right) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %left, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %right, i32 1)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3bd7ef4115f143c18e1e3a9956152519___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___64e4e2f88f6a4e0ba8535c480ca3d2b4___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___64e4e2f88f6a4e0ba8535c480ca3d2b4___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic___3bd7ef4115f143c18e1e3a9956152519___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___63c02f62e80445bcacb2cd0a2549daa4___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___63c02f62e80445bcacb2cd0a2549daa4___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___63c02f62e80445bcacb2cd0a2549daa4___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___3bd7ef4115f143c18e1e3a9956152519___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___3bd7ef4115f143c18e1e3a9956152519___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___63c02f62e80445bcacb2cd0a2549daa4___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___64e4e2f88f6a4e0ba8535c480ca3d2b4___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
