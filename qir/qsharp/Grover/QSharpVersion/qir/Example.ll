...
@6 = internal constant [28 x i8] c"reached unreachable code...\00"
@7 = internal constant [39 x i8] c"Array must be of the length at least 1\00"
...
continue__1:                                      ; No predecessors!
  %12 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @6, i32 0, i32 0))
...
entry:
  ...
  call void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__body(%Callable* %0, %Array* %inputQubits)
  call void @__quantum__rt__array_update_alias_count(%Array* %inputQubits, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___c883442202a44a4b870163cf130abc7f_IndexRange__body(%Array* %register)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3f85a1f2a80843aea8ef2fdcae555f3f___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %inputQubits, i32 1)
  %0 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Intrinsic__X__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  call void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__adj(%Callable* %0, %Array* %inputQubits)
  call void @__quantum__rt__array_update_alias_count(%Array* %inputQubits, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret void
...
define internal void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
entry:
  ...
  call void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__ctl(%Array* %__controlQubits__, { %Callable*, %Array* }* %1)
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %inputQubits, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__ctl(%Array* %__controlQubits__, { %Callable*, %Array* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  ...
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
  %3 = call %Range @Microsoft__Quantum__Arrays___c883442202a44a4b870163cf130abc7f_IndexRange__body(%Array* %register)
...
entry:
  ...
  store %Callable* %4, %Callable** %2, align 8
  store %Array* %inputQubits, %Array** %3, align 8
  call void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__ctladj(%Array* %__controlQubits__, { %Callable*, %Array* }* %1)
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %inputQubits, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %4, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %4, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___223aaae9de984c89bf07d203892167cf_ApplyToEachCA__ctladj(%Array* %__controlQubits__, { %Callable*, %Array* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %1 = getelementptr inbounds { %Callable*, %Array* }, { %Callable*, %Array* }* %0, i32 0, i32 0
  %singleElementOperation = load %Callable*, %Callable** %1, align 8
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3f85a1f2a80843aea8ef2fdcae555f3f___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %inputQubits, i32 1)
  %0 = call %Array* @Microsoft__Quantum__Arrays___bde4e5cc32aa4849aa5e647de6b07f8c_Most__body(%Array* %inputQubits)
  %1 = call %Qubit* @Microsoft__Quantum__Arrays___a6dc0dcbcf614854be04517bd0ca8ff7_Tail__body(%Array* %inputQubits)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3f85a1f2a80843aea8ef2fdcae555f3f___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
define internal %Array* @Microsoft__Quantum__Arrays___bde4e5cc32aa4849aa5e647de6b07f8c_Most__body(%Array* %array) {
entry:
...
define internal %Qubit* @Microsoft__Quantum__Arrays___a6dc0dcbcf614854be04517bd0ca8ff7_Tail__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = icmp sgt i64 %0, 0
  %2 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @7, i32 0, i32 0))
...
condContinue__2:                                  ; preds = %condFalse__2, %condTrue__2
  ...
  call void @Microsoft__Quantum__Canon___ba3eb388531b4e6aa5f8fec1a4368731_ApplyToEachA__body(%Callable* %0, %Array* %11)
...
condContinue__4:                                  ; preds = %condFalse__4, %condTrue__4
  ...
  call void @Microsoft__Quantum__Canon___ba3eb388531b4e6aa5f8fec1a4368731_ApplyToEachA__adj(%Callable* %12, %Array* %23)
...
define internal void @Microsoft__Quantum__Canon___ba3eb388531b4e6aa5f8fec1a4368731_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal void @Microsoft__Quantum__Canon___ba3eb388531b4e6aa5f8fec1a4368731_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
exit__1:                                          ; preds = %header__1
  ...
  %5 = call %Array* @Microsoft__Quantum__Arrays___2cab0173549e412882c0786d8e2d0fbe_ForEach__body(%Callable* %4, %Array* %qubits)
  call void @__quantum__rt__array_update_alias_count(%Array* %qubits, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %4, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %4, i32 -1)
...
define internal %Array* @Microsoft__Quantum__Arrays___2cab0173549e412882c0786d8e2d0fbe_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %9 = call %Range @Microsoft__Quantum__Arrays___c883442202a44a4b870163cf130abc7f_IndexRange__body(%Array* %array)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___2b7c57662470419a9bc27c95742a614b___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___2b7c57662470419a9bc27c95742a614b___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic___3f85a1f2a80843aea8ef2fdcae555f3f___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___780bef581477464dbfa1a9c029da5077___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___780bef581477464dbfa1a9c029da5077___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___780bef581477464dbfa1a9c029da5077___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___3f85a1f2a80843aea8ef2fdcae555f3f___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___3f85a1f2a80843aea8ef2fdcae555f3f___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___2b7c57662470419a9bc27c95742a614b___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___780bef581477464dbfa1a9c029da5077___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
then0__1:                                         ; preds = %entry
  call void @Microsoft__Quantum__Diagnostics___bfa66d65bd6a401db24a9c0f42a531be___QsRef2__FormattedFailure____body(i1 %actual, i1 %expected, %String* %message)
  br label %continue__1
...
define internal void @Microsoft__Quantum__Diagnostics___bfa66d65bd6a401db24a9c0f42a531be___QsRef2__FormattedFailure____body(i1 %actual, i1 %expected, %String* %message) {
entry:
...
define internal %Range @Microsoft__Quantum__Arrays___c883442202a44a4b870163cf130abc7f_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = sub i64 %0, 1
