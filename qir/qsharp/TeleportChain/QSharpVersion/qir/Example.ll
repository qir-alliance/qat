...
define internal void @QATSample__ApplyCorrection__body(%Qubit* %src, %Qubit* %intermediary, %Qubit* %dest) {
entry:
...
define internal void @QATSample__DemonstrateTeleportationUsingPresharedEntanglement__body() {
entry:
  ...
  call void @QATSample__PrepareEntangledPair__body(%Qubit* %leftMessage, %Qubit* %rightMessage)
  br label %header__1
...
body__1:                                          ; preds = %header__1
  ...
  call void @QATSample__PrepareEntangledPair__body(%Qubit* %3, %Qubit* %6)
  br label %exiting__1
...
exit__1:                                          ; preds = %header__1
  ...
  call void @QATSample__TeleportQubitUsingPresharedEntanglement__body(%Qubit* %rightMessage, %Qubit* %10, %Qubit* %13)
  br label %header__2
...
body__2:                                          ; preds = %header__2
  ...
  call void @QATSample__TeleportQubitUsingPresharedEntanglement__body(%Qubit* %18, %Qubit* %21, %Qubit* %24)
  br label %exiting__2
...
define internal void @QATSample__PrepareEntangledPair__body(%Qubit* %left, %Qubit* %right) {
entry:
...
define internal void @QATSample__TeleportQubitUsingPresharedEntanglement__body(%Qubit* %src, %Qubit* %intermediary, %Qubit* %dest) {
entry:
  call void @QATSample__PrepareEntangledPair__adj(%Qubit* %src, %Qubit* %intermediary)
  call void @QATSample__ApplyCorrection__body(%Qubit* %src, %Qubit* %intermediary, %Qubit* %dest)
  ret void
}
...
define internal void @QATSample__PrepareEntangledPair__adj(%Qubit* %left, %Qubit* %right) {
entry:
...
define internal void @QATSample__PrepareEntangledPair__ctl(%Array* %__controlQubits__, { %Qubit*, %Qubit* }* %0) {
entry:
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___09da53f1012143419c9edd387b423b86___QsRef21__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___171c64baf696466a855469dc9157522a___QsRef21__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @QATSample__PrepareEntangledPair__ctladj(%Array* %__controlQubits__, { %Qubit*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %1 = getelementptr inbounds { %Qubit*, %Qubit* }, { %Qubit*, %Qubit* }* %0, i32 0, i32 0
  %left = load %Qubit*, %Qubit** %1, align 8
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyControlledZ____body(%Qubit* %control, %Qubit* %target) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyControlledZ____adj(%Qubit* %control, %Qubit* %target) {
entry:
  call void @__quantum__qis__cz__body(%Qubit* %control, %Qubit* %target)
  ret void
}

define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____body(double %theta) {
entry:
  ret void
}

define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____adj(double %theta) {
entry:
  ret void
}

define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____ctl(%Array* %controls, double %theta) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____ctladj(%Array* %controls, double %theta) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %controls, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %controls)
  %1 = icmp sgt i64 %0, 0
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyUncontrolledZ____body(%Qubit* %qubit) {
entry:
  call void @__quantum__qis__z__body(%Qubit* %qubit)
  ret void
}
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyUncontrolledZ____adj(%Qubit* %qubit) {
entry:
  call void @__quantum__qis__z__body(%Qubit* %qubit)
  ret void
}
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__MapPauli____body(%Qubit* %qubit, i2 %from, i2 %to) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic____QsRef21__MapPauli____adj(%Qubit* %qubit, i2 %from, i2 %to) {
entry:
  %0 = icmp eq i2 %from, %to
  br i1 %0, label %then0__1, label %test1__1
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___09da53f1012143419c9edd387b423b86___QsRef21__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
define internal void @Microsoft__Quantum__Intrinsic___171c64baf696466a855469dc9157522a___QsRef21__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
body__1:                                          ; preds = %header__1
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__PhaseCCX____body(%Qubit* %9, %Qubit* %14, %Qubit* %17)
  br label %exiting__1
...
body__2:                                          ; preds = %header__2
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__PhaseCCX____adj(%Qubit* %52, %Qubit* %57, %Qubit* %60)
  br label %exiting__2
...
define internal void @Microsoft__Quantum__Intrinsic___09da53f1012143419c9edd387b423b86___QsRef21__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
body__1:                                          ; preds = %header__1
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__PhaseCCX____body(%Qubit* %8, %Qubit* %13, %Qubit* %16)
  br label %exiting__1
...
body__2:                                          ; preds = %header__2
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__PhaseCCX____adj(%Qubit* %51, %Qubit* %56, %Qubit* %59)
  br label %exiting__2
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____body(double %7)
  br label %continue__1
...
else__1:                                          ; preds = %test2__1
  %6 = fneg double %theta
  %7 = fdiv double %6, 2.000000e+00
  call void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____adj(double %7)
  br label %continue__1
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____ctl(%Array* %__controlQubits__, double %23)
  br label %continue__1
...
then1__1:                                         ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__MapPauli____body(%Qubit* %qubit, i2 %7, i2 %8)
  %9 = call %Tuple* @__quantum__rt__tuple_create(i64 ptrtoint ({ double, %Qubit* }* getelementptr ({ double, %Qubit* }, { double, %Qubit* }* null, i32 1) to i64))
  %10 = bitcast %Tuple* %9 to { double, %Qubit* }*
  %11 = getelementptr inbounds { double, %Qubit* }, { double, %Qubit* }* %10, i32 0, i32 0
  %12 = getelementptr inbounds { double, %Qubit* }, { double, %Qubit* }* %10, i32 0, i32 1
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__MapPauli____adj(%Qubit* %qubit, i2 %13, i2 %14)
  call void @__quantum__rt__tuple_update_reference_count(%Tuple* %9, i32 -1)
  br label %continue__1
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___98e7f0e403d14ed39156a6d7e59e4399___QsRef21__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___98e7f0e403d14ed39156a6d7e59e4399___QsRef21__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
else__1:                                          ; preds = %test2__1
  %22 = fneg double %theta
  %23 = fdiv double %22, 2.000000e+00
  call void @Microsoft__Quantum__Intrinsic____QsRef21__ApplyGlobalPhase____ctladj(%Array* %__controlQubits__, double %23)
  br label %continue__1
...
define internal void @Microsoft__Quantum__Intrinsic___98e7f0e403d14ed39156a6d7e59e4399___QsRef21__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___09da53f1012143419c9edd387b423b86___QsRef21__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
then2__1:                                         ; preds = %test2__1
  ...
  %12 = bitcast i8* %11 to %Qubit**
  %13 = load %Qubit*, %Qubit** %12, align 8
  call void @Microsoft__Quantum__Intrinsic____QsRef21__CCZ____body(%Qubit* %10, %Qubit* %13, %Qubit* %qubit)
  br label %continue__1

else__1:                                          ; preds = %test2__1
  %14 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Intrinsic__Z__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  call void @__quantum__rt__callable_make_controlled(%Callable* %14)
  %15 = call %Tuple* @__quantum__rt__tuple_create(i64 ptrtoint ({ %Array*, %Qubit* }* getelementptr ({ %Array*, %Qubit* }, { %Array*, %Qubit* }* null, i32 1) to i64))
  %16 = bitcast %Tuple* %15 to { %Array*, %Qubit* }*
  %17 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %16, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___09da53f1012143419c9edd387b423b86___QsRef21__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___98e7f0e403d14ed39156a6d7e59e4399___QsRef21__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
body__2:                                          ; preds = %header__2
  ...
  call void @Microsoft__Quantum__Intrinsic____QsRef21__PhaseCCX____adj(%Qubit* %53, %Qubit* %58, %Qubit* %61)
  br label %exiting__2
...
define internal void @Microsoft__Quantum__Intrinsic___171c64baf696466a855469dc9157522a___QsRef21__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define void @QATSample__DemonstrateTeleportationUsingPresharedEntanglement__Interop() #1 {
entry:
  call void @QATSample__DemonstrateTeleportationUsingPresharedEntanglement__body()
  ret void
}

define void @QATSample__DemonstrateTeleportationUsingPresharedEntanglement() #2 {
entry:
  call void @QATSample__DemonstrateTeleportationUsingPresharedEntanglement__body()
