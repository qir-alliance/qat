...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___679897c0d5ea461fbf562e36c6fc9634___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
continue__1:                                      ; preds = %condContinue__1
  %7 = call %Array* @Microsoft__Quantum__Arrays___e07b2363700349a982cf24cba6cbef10_Zipped__body(%Array* %shift, %Array* %qs)
...
exit__1:                                          ; preds = %header__1
  ...
  %22 = call %Array* @Microsoft__Quantum__Arrays___e07b2363700349a982cf24cba6cbef10_Zipped__body(%Array* %shift, %Array* %qs)
  %23 = call %Array* @Microsoft__Quantum__Arrays___e07b2363700349a982cf24cba6cbef10_Zipped__body(%Array* %shift, %Array* %qs)
...
define internal %Array* @Microsoft__Quantum__Arrays___e07b2363700349a982cf24cba6cbef10_Zipped__body(%Array* %left, %Array* %right) {
entry:
...
entry:
  ...
  call void @Microsoft__Quantum__Canon___c840b4a6fb0d47b2a038180b73724945_ApplyToEach__body(%Callable* %0, %Array* %qubits)
  ...
  call void @Microsoft__Quantum__Canon___b8e63fadf16749c9ad0b9c5ffffad533_ApplyToEachA__body(%Callable* %4, %Array* %qubits)
  ...
  call void @Microsoft__Quantum__Canon___b8e63fadf16749c9ad0b9c5ffffad533_ApplyToEachA__adj(%Callable* %8, %Array* %qubits)
  ...
  %10 = call %Array* @Microsoft__Quantum__Arrays___55b050883c50445387eaa626a31a4476_ForEach__body(%Callable* %9, %Array* %qubits)
  call void @__quantum__rt__array_update_alias_count(%Array* %qubits, i32 -1)
  call void @__quantum__rt__capture_update_alias_count(%Callable* %Ufstar, i32 -1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %Ufstar, i32 -1)
  call void @__quantum__rt__capture_update_alias_count(%Callable* %Ug, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___c840b4a6fb0d47b2a038180b73724945_ApplyToEach__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___cd1aee10741940bc96ae42ba91e2be7e_IndexRange__body(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___b8e63fadf16749c9ad0b9c5ffffad533_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal void @Microsoft__Quantum__Canon___b8e63fadf16749c9ad0b9c5ffffad533_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___55b050883c50445387eaa626a31a4476_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %9 = call %Range @Microsoft__Quantum__Arrays___cd1aee10741940bc96ae42ba91e2be7e_IndexRange__body(%Array* %array)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___679897c0d5ea461fbf562e36c6fc9634___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal %Range @Microsoft__Quantum__Arrays___cd1aee10741940bc96ae42ba91e2be7e_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___679897c0d5ea461fbf562e36c6fc9634___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___562742e1dcde49d6a8c3acb7831a7cd9___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___562742e1dcde49d6a8c3acb7831a7cd9___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic___679897c0d5ea461fbf562e36c6fc9634___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___eebba0469314411d85945ad57fddb837___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___eebba0469314411d85945ad57fddb837___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___eebba0469314411d85945ad57fddb837___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___679897c0d5ea461fbf562e36c6fc9634___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___679897c0d5ea461fbf562e36c6fc9634___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___eebba0469314411d85945ad57fddb837___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___562742e1dcde49d6a8c3acb7831a7cd9___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
