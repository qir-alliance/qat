...
entry:
  %ret = call i64 @LoopCase__Value__body(i64 2)
  ret i64 %ret
}

define internal i64 @LoopCase__Value__body(i64 %q) {
entry:
  %0 = icmp eq i64 %q, 0
...
define i64 @LoopCase__Main__Interop(i64 %nrIter) #0 {
entry:
  %0 = call i64 @LoopCase__Main__body(i64 %nrIter)
  ret i64 %0
}

define void @LoopCase__Main(i64 %nrIter) #1 {
entry:
  %0 = call i64 @LoopCase__Main__body(i64 %nrIter)
