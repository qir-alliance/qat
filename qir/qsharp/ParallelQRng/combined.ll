...
body__1:                                          ; preds = %Microsoft__Quantum__Samples__SampleRandomNumber__body.1.exit, %exit_quantum_grouping
  %89 = phi i64 [ %94, %exit_quantum_grouping ], [ 0, %Microsoft__Quantum__Samples__SampleRandomNumber__body.1.exit ]
  %90 = add i64 %89, %87
...
exit__1:                                          ; preds = %exit_quantum_grouping, %Microsoft__Quantum__Samples__SampleRandomNumber__body.1.exit
...
body__1.i:                                        ; preds = %else__1, %exit_quantum_grouping8
  %12 = phi i64 [ %21, %exit_quantum_grouping8 ], [ 0, %else__1 ]
  %13 = shl nuw i64 %12, 1
...
exit__1.i:                                        ; preds = %exit_quantum_grouping8, %else__1
...
body__2.i:                                        ; preds = %exit_quantum_grouping13, %body__2.preheader.i
  %40 = phi i64 [ %49, %exit_quantum_grouping13 ], [ %__qsVar0____qsVar0__numPair____3.i, %body__2.preheader.i ]
  %41 = shl nuw i64 %40, 1
...
Microsoft__Quantum__Intrinsic___39c4c69246f74f58bd1ae3f69e5948c0___QsRef23__ApplyWithLessControlsA____body.exit: ; preds = %exit_quantum_grouping13, %condContinue__1.i
  tail call void @__quantum__rt__array_update_alias_count(%Array* %temps.i, i32 -1)
  tail call void @__quantum__rt__array_update_alias_count(%Array* %__qsVar1__newControls__.i, i32 -1)
  tail call void @__quantum__rt__array_update_reference_count(%Array* %__qsVar1__newControls__.i, i32 -1)
  tail call void @__quantum__rt__array_update_reference_count(%Array* %__qsVar1__newControls__.i, i32 -1)
...
continue__1:                                      ; preds = %Microsoft__Quantum__Intrinsic___39c4c69246f74f58bd1ae3f69e5948c0___QsRef23__ApplyWithLessControlsA____body.exit, %exit_quantum_grouping3, %exit_quantum_grouping
  tail call void @__quantum__rt__array_update_alias_count(%Array* %ctls, i32 -1)
  ret void
}
