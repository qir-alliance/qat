...
define internal %Array* @Microsoft__Quantum__Samples__SampleRandomNumber__body() {
entry:
  ...
  call void @Microsoft__Quantum__Canon___0a8bf928e69a4981838a504f7d348636_ApplyToEachA__body(%Callable* %0, %Array* %register)
  %1 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Samples__T__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %y = call %Array* @Microsoft__Quantum__Arrays___c8ec7162809243358e7c013c92fb00fd_ForEach__body(%Callable* %1, %Array* %register)
  call void @__quantum__rt__array_update_alias_count(%Array* %y, i32 1)
  %2 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Measurement__MResetZ__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %x = call %Array* @Microsoft__Quantum__Arrays___88526f5f84b4458bac21cec18cd20b1b_ForEach__body(%Callable* %2, %Array* %register)
  call void @__quantum__rt__array_update_alias_count(%Array* %x, i32 1)
  %3 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Measurement__MResetZ__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %4 = call %Array* @Microsoft__Quantum__Arrays___88526f5f84b4458bac21cec18cd20b1b_ForEach__body(%Callable* %3, %Array* %register)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %y, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %x, i32 -1)
  ...
  %5 = call i64 @__quantum__rt__array_get_size_1d(%Array* %x)
  %6 = sub i64 %5, 1
  br label %header__1
...
body__1:                                          ; preds = %header__1
  %9 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %x, i64 %7)
...
define internal void @Microsoft__Quantum__Canon___0a8bf928e69a4981838a504f7d348636_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
  %0 = call %Range @Microsoft__Quantum__Arrays___3928947d41eb4fcbaeeca4dc68f17927_IndexRange__body(%Array* %register)
...
define internal %Array* @Microsoft__Quantum__Arrays___c8ec7162809243358e7c013c92fb00fd_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %8 = call %Range @Microsoft__Quantum__Arrays___3928947d41eb4fcbaeeca4dc68f17927_IndexRange__body(%Array* %array)
...
header__2:                                        ; preds = %exiting__2, %preheader__1
  %idxElement = phi i64 [ %9, %preheader__1 ], [ %30, %exiting__2 ]
...
body__2:                                          ; preds = %header__2
  ...
  %22 = bitcast %Tuple* %21 to { %Qubit* }*
  %23 = getelementptr inbounds { %Qubit* }, { %Qubit* }* %22, i32 0, i32 0
  ...
  call void @__quantum__rt__callable_invoke(%Callable* %action, %Tuple* %21, %Tuple* %24)
...
define internal void @Microsoft__Quantum__Samples__T__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  %0 = bitcast %Tuple* %arg-tuple to { %Qubit* }*
  %1 = getelementptr inbounds { %Qubit* }, { %Qubit* }* %0, i32 0, i32 0
  %2 = load %Qubit*, %Qubit** %1, align 8
  %3 = call i64 @Microsoft__Quantum__Samples__T__body(%Qubit* %2)
...
define internal %Array* @Microsoft__Quantum__Arrays___88526f5f84b4458bac21cec18cd20b1b_ForEach__body(%Callable* %action, %Array* %array) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %action, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %action, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
exit__1:                                          ; preds = %header__1
  ...
  %9 = call %Range @Microsoft__Quantum__Arrays___3928947d41eb4fcbaeeca4dc68f17927_IndexRange__body(%Array* %array)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___49316b57a7f7472d8cfc103f19b77b12___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal i64 @Microsoft__Quantum__Samples__T__body(%Qubit* %q) {
entry:
  ret i64 0
}
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___49316b57a7f7472d8cfc103f19b77b12___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___49316b57a7f7472d8cfc103f19b77b12___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___b7ed349ced7a466998fa8edf43d11dd0___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___b7ed349ced7a466998fa8edf43d11dd0___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
define internal void @Microsoft__Quantum__Intrinsic___49316b57a7f7472d8cfc103f19b77b12___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3bf25b82eadf4b49b07e2cafb1e6428c___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3bf25b82eadf4b49b07e2cafb1e6428c___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___3bf25b82eadf4b49b07e2cafb1e6428c___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___49316b57a7f7472d8cfc103f19b77b12___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___49316b57a7f7472d8cfc103f19b77b12___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___b7ed349ced7a466998fa8edf43d11dd0___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___3bf25b82eadf4b49b07e2cafb1e6428c___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal %Range @Microsoft__Quantum__Arrays___3928947d41eb4fcbaeeca4dc68f17927_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = sub i64 %0, 1
...
define internal void @Microsoft__Quantum__Canon___0a8bf928e69a4981838a504f7d348636_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define { i64, i8* }* @Microsoft__Quantum__Samples__SampleRandomNumber__Interop() #1 {
entry:
  %0 = call %Array* @Microsoft__Quantum__Samples__SampleRandomNumber__body()
...
define void @Microsoft__Quantum__Samples__SampleRandomNumber() #2 {
entry:
  %0 = call %Array* @Microsoft__Quantum__Samples__SampleRandomNumber__body()
