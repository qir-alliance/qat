...
entry:
  ...
  tail call void @__quantum__rt__array_update_alias_count(%Array* %x.i, i32 1)
...
Microsoft__Quantum__Samples__CountNumbers__body.1.exit: ; preds = %body__1.i.i, %entry
  ...
  tail call void @__quantum__rt__array_update_alias_count(%Array* %34, i32 1)
  %55 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %34, i64 3)
  %56 = bitcast i8* %55 to %Qubit**
  tail call void @__quantum__rt__array_update_alias_count(%Array* %34, i32 -1)
  tail call void @__quantum__rt__array_update_alias_count(%Array* %x.i, i32 -1)
  tail call void @__quantum__rt__array_update_reference_count(%Array* %34, i32 -1)
  tail call void @__quantum__rt__array_update_reference_count(%Array* %x.i, i32 -1)
