...
available4 = [
    ...
    "Decompositions/IControlledAdjoint.qs",
    "Decompositions/M.qs",
    # TODO(tfr): not straightline input "Decompositions/MResetX.qs",
    "Decompositions/MResetY.qs",
    "Decompositions/MResetZ.qs",
    "Decompositions/R.qs",
    "Decompositions/RAdjoint.qs",
    # TODO(tfr): not straightline input "Decompositions/RControlled.qs",
    # TODO(tfr): not straightline input "Decompositions/RAdjointControlled.qs",
    # TODO(tfr): not straightline input "Decompositions/RControlledAdjoint.qs",
    "Decompositions/R1.qs",
    "Decompositions/R1Adjoint.qs",
    "Decompositions/R1Controlled.qs",
    "Decompositions/R1AdjointControlled.qs",
    ...
    "Decompositions/RFrac.qs",
    "Decompositions/RFracAdjoint.qs",
    # TODO(tfr): not straightline input "Decompositions/RFracControlled.qs",
    # TODO(tfr): not straightline input "Decompositions/RFracAdjointControlled.qs",
    # TODO(tfr): not straightline input "Decompositions/RFracControlledAdjoint.qs",
    "Decompositions/Reset.qs",
    "Decompositions/ResetAdjoint.qs",
    "Decompositions/ResetControlled.qs",
    "Decompositions/ResetAdjointControlled.qs",
    ...
    "Decompositions/Rx.qs",
    "Decompositions/RxAdjoint.qs",
    # TODO(tfr): not straightline input "Decompositions/RxControlled.qs",
    # TODO(tfr): not straightline input "Decompositions/RxAdjointControlled.qs",
    # TODO(tfr): not straightline input "Decompositions/RxControlledAdjoint.qs",
    "Decompositions/Ry.qs",
    "Decompositions/RyAdjoint.qs",
    "Decompositions/RyControlled.qs",
    "Decompositions/RyAdjointControlled.qs",
    ...
    "Decompositions/SWAPAdjointControlled.qs",
    "Decompositions/SWAPControlledAdjoint.qs",
    # TODO(tfr): Not supported by hardware "Decompositions/SetToBasisState.qs",
    "Decompositions/T.qs",
    "Decompositions/TAdjoint.qs",
    "Decompositions/TControlled.qs",
    "Decompositions/TAdjointControlled.qs",
