...
available4 = [
    ...
    "Decompositions/MeasureEachZ.qs",
    "Decompositions/M.qs",
    # TODO(issue-91): Not straight line code "Decompositions/MResetX.qs",
    "Decompositions/MResetY.qs",
    "Decompositions/MResetZ.qs",
    "Decompositions/R.qs",
    "Decompositions/RAdjoint.qs",
    # TODO(issue-91): Not straight line code "Decompositions/RControlled.qs",
    # TODO(issue-91): Not straight line code "Decompositions/RAdjointControlled.qs",
    # TODO(issue-91): Not straight line code "Decompositions/RControlledAdjoint.qs",
    "Decompositions/R1.qs",
    "Decompositions/R1Adjoint.qs",
    "Decompositions/R1Controlled.qs",
    "Decompositions/R1AdjointControlled.qs",
    ...
    "Decompositions/Rx.qs",
    "Decompositions/RxAdjoint.qs",
    # TODO(issue-91): Not straight line code "Decompositions/RxControlled.qs",
    # TODO(issue-91): Not straight line code "Decompositions/RxAdjointControlled.qs",
    # TODO(issue-91): Not straight line code "Decompositions/RxControlledAdjoint.qs",
    "Decompositions/Ry.qs",
    "Decompositions/RyAdjoint.qs",
    "Decompositions/RyControlled.qs",
    "Decompositions/RyAdjointControlled.qs",
