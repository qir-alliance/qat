...
available4 = [
    ...
    "Decompositions/R.qs",
    "Decompositions/RAdjoint.qs",
    # TODO(issue-91): not straightline input "Decompositions/RControlled.qs",
    # TODO(issue-91): not straightline input "Decompositions/RAdjointControlled.qs",
    # TODO(issue-91): not straightline input "Decompositions/RControlledAdjoint.qs",
    "Decompositions/R1.qs",
    "Decompositions/R1Adjoint.qs",
    "Decompositions/R1Controlled.qs",
    "Decompositions/R1AdjointControlled.qs",
    ...
    "Decompositions/RFrac.qs",
    "Decompositions/RFracAdjoint.qs",
    # TODO(issue-91): not straightline input "Decompositions/RFracControlled.qs",
    # TODO(issue-91): not straightline input "Decompositions/RFracAdjointControlled.qs",
    # TODO(issue-91): not straightline input "Decompositions/RFracControlledAdjoint.qs",
    "Decompositions/Reset.qs",
    "Decompositions/ResetAdjoint.qs",
    "Decompositions/ResetControlled.qs",
    "Decompositions/ResetAdjointControlled.qs",
    ...
    "Decompositions/Rx.qs",
    "Decompositions/RxAdjoint.qs",
    # TODO(issue-91): not straightline input "Decompositions/RxControlled.qs",
    # TODO(issue-91): not straightline input "Decompositions/RxAdjointControlled.qs",
    # TODO(issue-91): not straightline input "Decompositions/RxControlledAdjoint.qs",
    "Decompositions/Ry.qs",
    "Decompositions/RyAdjoint.qs",
    "Decompositions/RyControlled.qs",
    "Decompositions/RyAdjointControlled.qs",
