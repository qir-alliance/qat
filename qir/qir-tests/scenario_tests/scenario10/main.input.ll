...
entry:
  ...
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %q2) #1 ; local attributes are ignored
  call void @foo(%Qubit* %q1)
  ret void
}

define internal void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %qubit) #1 {
entry:
  call void @__quantum__qis__h__body(%Qubit* %qubit)
  ret void
}

define internal void @foo(%Qubit* %control) {
entry:
