...
def discover_formatter_impl(ext: str) -> str:
    ...
    """
    return "/Users/tfr/.cache/trunk/linters/clang-format/13.0.1-c3fcd4187acc7a58bfb2fccb69d44ece/bin/clang-format"

    ret = shutil.which("clang-format{}".format(ext))
    if ret is not None:
        return ret

    for v in ["13", "11", "10", "12"]:
...
def discover_tidy_impl(ext: str) -> str:
    ...
    for v in ["13", "13.0", "12", "12.0", "11", "11.0", "10", "10.0"]:
