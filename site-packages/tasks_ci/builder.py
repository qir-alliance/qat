...
from . import settings, toolchain
...
def configure_cmake(
    build_dir: str, generator=None, cmake_flags: Optional[List[str]] = None
) -> None:
    """
...
def build_project(
    build_dir: str, generator: OptionalStr = None, concurrency: OptionalInt = None
) -> None:
    """
...
def run_tests(build_dir: str, concurrency: OptionalInt = None) -> None:
    ...
    # TODO(issue-23): Consider whether lit should be moved back into the system
    if False:
        # Running lit tests
        lit_cmd = ["lit", "tests/", "-v"]
